...
const EmployeeCard: React.FC<EmployeeCardProps> = ({
  name, email, age, department, rating, bookmarked, onView, onBookmark, onPromote
}) => (
  <div className="bg-white dark:bg-gray-900 rounded-xl shadow-lg p-6 flex flex-col gap-3 border border-gray-100 dark:border-gray-800 hover:shadow-2xl transition-shadow duration-300 group">
    ...
    <div className="flex gap-2 mt-2">
      <button className="btn btn-primary px-3 py-1.5" onClick={onView}>View</button>
