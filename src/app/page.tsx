...
// import { ChartBarIcon, UserCircleIcon, ArrowRightIcon, CheckCircleIcon, ChartBarSquareIcon, DevicePhoneMobileIcon, CodeBracketIcon } from '@heroicons/react/24/solid';
...
//                 <Link href="/dashboard">
//                   <span className="text-blue-400 hover:underline text-sm cursor-pointer">Go to User Dashboard</span>
//                 </Link>
//               </div>
//             </div>
//           )}
...
//               },
//               particles: {
//                 color: { value: ["#2563eb", "#818cf8", "#38bdf8", "#f472b6", "#fbbf24"] },
//                 links: { enable: true, color: "#38bdf8", distance: 120, opacity: 0.3, width: 2 },
...
//           {features.map((f, i) => (
//             <div key={i} className="bg-gray-900/80 rounded-xl p-8 flex flex-col items-center text-center shadow hover:shadow-xl transition box-hover-animate">
//               {f.icon}
...
//           {whyUs.map((reason, i) => (
//             <div key={i} className="flex items-center gap-3 bg-gray-900/70 rounded-lg p-5 box-hover-animate">
//               {reason.icon}
...
//             <div key={i} className="flex items-start gap-4 bg-gray-900/80 rounded-xl p-6 shadow hover:shadow-xl transition border border-gray-800 box-hover-animate">
//               <div>{adv.icon}</div>
//               <div>
...
//       <section id="testimonials" className="py-16 px-6 max-w-6xl mx-auto w-full">
//         <div className="flex flex-col items-center mb-10">
...
//             <div key={i} className="bg-gray-900/80 rounded-xl p-8 flex flex-col shadow hover:shadow-xl transition border border-gray-800 box-hover-animate">
